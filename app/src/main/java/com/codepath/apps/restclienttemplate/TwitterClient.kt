...
class TwitterClient(context: Context) : OAuthBaseClient(
    ...
    companion object {
        val REST_API_INSTANCE = TwitterApi.instance() // calling Twitter API

        const val REST_URL = "https://api.twitter.com/1.1" // Twitter base API URL
    ...
    // calling GET endpoint with parameters
    ...
    // calling POST endpoint with parameters
